...
class Step3Page(QWidget):
    ...
    def init_ui(self):
        ...
        # 欢迎标题
        title = QLabel("油气新能源生产调度指挥系统出库数据")
    ...
    def create_extra_file_section(self, layout):
        """创建额外文件区域"""
        self.extra_group = QGroupBox("A8系统数据推送表文件")
        ...
        self.extra_drop_label = QLabel("拖放A8系统数据推送表文件到这里\n或点击选择文件")
